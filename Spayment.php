...
$id=$_GET['idsupplier']; ?>
    <td><a href="spaymentbill.php?id=<?php echo $id; ?>" class="btn btn-sm btn-success mt-3 mb-2">Print </a></td>
  </tr>
  </table>
            <div class="row">
                <div class="col-12">
      ...
      <form id="addpt" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="due" value="<?php echo $_SESSION['remaining']; ?>"
                                       readonly >
                                </div>
                            <div class="form-group">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="editpt">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="amount">Amount</label>
                                    <input type="text" class="form-control" id="amount" placeholder="Amount" name="name"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="date">Date</label>
           ...
           // alert(deleteid);
            swal({
                ...
                if (willDelete) {
                   $.ajax({
                       type: "POST",
                       url: "deletePurchaseRemaining.php",
                       data: {
                           "delete_btn_set":1,
                           "deleteid":deleteid,
                       },                      
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql=mysqli_query($conn, "insert into supplier_remaining_pay (supplier,due,pay,date,description) values('$name','$due','$amount','$date','$description')");
        if($sql){
            echo "<script>window.location.href='https://aliauto.cte.com.pk/viewsupplier.php?idsupplier=$ids' </script>";
        }else{

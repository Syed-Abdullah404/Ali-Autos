...
if(isset($_REQUEST['price_form'])){
    ...
    $bill_detail=$_POST['name'];
     ...
     $rem=$_POST['rempay'];
    $conn->query("insert into sale_product_details set customer='$bill_detail',bill_id='$suppler_detail',status='$status_detail',sub_total='$sub_total',discount_total='$discount',grand_total='$finaltotal',final_total='$wht',paid='$paid',remaining='$rem'");

...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2022 at 09:33 AM
...
(1, 'supplier', 'hassan', 'admin@gmail.com', '200', '18:57:00', '2022-05-21', 'payable', 'amad'),
(6, 'customer', 'ammad ahmad', 'aslam@gmail.com', '210', '19:29:00', '2022-05-26', 'payable', '123');
...
(5, 'new customer', 'customer@gmail.com', 'customers/psdToHtml.png', 'bb', '34101645782477', '0300-6412623', 'lahore'),
(6, 'qasim', 'Qasim@mgail.com', '', '', '', '', '');
...
--
-- Dumping data for table `customer_remaining_pay`
--

INSERT INTO `customer_remaining_pay` (`id`, `customer`, `due`, `pay`, `date`, `description`) VALUES
(1, 'New Asia ', '0', '1188000', '2021-12-22', ''),
(2, 'New Asia ', '487.04', '487.04', '2022-02-20', '');
...
(9, '8000', 'recovery', 'test', '2021-12-17'),
(10, '50000', 'recovery', '', '2021-12-22'),
(11, '20000', 'payment', '4 CO2 Coil ,   5 Flp , 10 pec Gloves , Safeed shisha , Mati ka teel , Mobile ', '2021-12-22'),
(12, '500', 'recovery', 'aslam saab\r\n', '2022-05-21');
...
(5, 'test employee', '123456', '6545322', 'gujranwala', 'contract 1', 'monthly', '25000', '2021-11-06', 'employee/dummy.jpg'),
(6, 'test', '123', '52152', 'gujranwala', 'c1', 'monthly', '30000', '2021-11-06', 'employee/dummy.jpg'),
(7, 'e test', '12331', '987456', ' grw , punjab', 'no', 'monthly', '15000', '2021-12-17', 'employee/psdToHtml.png');
...
(5, 'ready', 'test product', '10', '0', '2021-12-17', 7);
...
(1, 'p1 ready', 'ready', -100),
(2, 'p1 raw', 'raw', -148),
(4, 'p2', 'ready', -34515),
(6, 'test', 'ready', -34505),
(8, 'Hr Coil', 'raw', -749992),
(9, 'pencil', 'raw', -5),
(11, 'Cargo Loader', 'ready', 0),
(12, 'test product', 'ready', -1),
(13, 'quiz', 'ready', 590),
(14, 'hr coil', 'raw', 0),
(15, 'wheel rim Fancy', 'ready', -5300),
(16, 'hr coil', 'raw', 0),
(17, 'hr coil', 'raw', 0),
(18, 'new product', 'ready', 46492),
(19, 'new raw product', 'raw', 84190),
(20, 'Fancy tikki', 'raw', 0),
(21, 'Facny Kara', 'raw', 0),
(22, 'Wheel Rim Cargo', 'raw', 0),
(23, 'Wheel rim N.A model', 'ready', 0),
(24, 'Hr Coil', 'raw', 0),
(25, 'Hr Coil', 'raw', 0),
(26, 'ai', 'ready', -12),
(27, 'p3', 'raw', 0);
...
(21, 'new supplier', '0001', 'unpaid', 'new raw product', '100000', '500', '2022-01-02', '50,000,000.00'),
(22, 'Mohsin Sb', '2', 'unpaid', 'Hr Coil 1', '10000', '200', '2022-02-20', '2,000,000.00');
...
(3, 'ready', 'p1 ready', '500', 'loss'),
(4, 'ready', 'test product', '10', 'test'),
(5, 'ready', 'ai', '12', '21');
...
(15, 'wheel rim Fancy', 'ready', 'ready 1', 'kg', 'active'),
(22, 'Wheel Rim Cargo', 'ready', 'Cargo Kara', 'kg', 'active'),
(23, 'Wheel rim N.A model', 'ready', 'Fancy tikki', 'kg', 'active'),
(24, 'Hr Coil', 'raw', 'Sheet 2.5mm', 'kg', 'active'),
(25, 'Hr Coil 1', 'raw', 'sheet 3mm', 'kg', 'active'),
(26, 'ai', 'ready', '-- Select Sub Category --', 'kg', 'active'),
(27, 'p2', 'raw', 'raw', 'kg', 'active'),
(28, 'p3', 'raw', 'Fancy Kara', 'kg', 'active');
...
(19, 'new supplier', '0001', 'unpaid', '50,000,000.00', '25,000,000.00', '27,500,000.00', '28,875,000.00', '0', '28,875,000.00'),
(20, 'Mohsin Sb', '2', 'unpaid', '2,000,000.00', '', '', '', '0', '');
...
(6, 'test', 'p1 raw', '10'),
(9, 'pencil', 'pencil', '20'),
(10, 'test product', 'pencil', '1'),
(18, 'quiz', 'pencil', '5'),
(34, 'Cargo Loader', 'Hr Coil', '40000'),
(35, 'new product', 'new raw product', '10000');
...
(3, '20000', '2021-11-06', 5),
(4, '20000', '2021-11-06', 6),
(5, '15000', '2021-12-17', 7);
...
(72, 'qasim', '112', 'unpaid', 'new product', '2', '1', '2022-05-22', '2.00');
...
(52, 'qasim', '112', 'unpaid', '2.00', '2.00', '2.00', '2.00', '0', '2.00');
...
(13, 'Fancy Tikki', 'raw', 'active'),
(14, 'Fancy Kara', 'raw', 'active'),
(15, 'Cargo Tikki', 'raw', 'active'),
(16, 'Cargo Kara', 'ready', 'active'),
(17, 'Fancy tikki', 'ready', 'active'),
(18, 'Fancy Kara', 'raw', 'active'),
(19, 'Sheet 2.5mm', 'raw', 'active'),
(20, 'sheet 3mm', 'raw', 'active');
...
INSERT INTO `supplier` (`id`, `name`, `email`, `business_name`, `mobile`, `address`, `cnic`) VALUES
(17, 'ali', 'ali@gmail.com', '', '020030203', '', '');
...
--
-- Dumping data for table `supplier_remaining_pay`
--

INSERT INTO `supplier_remaining_pay` (`id`, `supplier`, `due`, `pay`, `date`, `description`) VALUES
(3, 'Mohsin Sb', '1199376.3', '1270', '2021-12-24', 'test'),
(4, 'Mohsin Sb', '1200646.3', '80000', '2021-12-24', 'check');

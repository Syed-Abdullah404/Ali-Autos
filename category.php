         ...
         <div class="card mm">
              <div class="card-header border-0">
                ...
                <!-- Button trigger modal -->
                 <button type="button" class="btn btn-primary float-end mn d-none" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
include 'footer.php';
    ...
    if(isset($_POST['add'])){
        ...
        $result=mysqli_query($conn,"insert into categories (name,status) values('$cat','$status')");
        if($result){
          ?>
          <script>
              window.location = "<?php echo $app_url.'/category.php' ?>";
          </script>

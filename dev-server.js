            ...
            <table name="cart">
                ...
                <tr>
                    ...
                    <td>
                        Tax:
                        <select name="tax">
                            <option value="">CT Tax</option>
                            <option selected value="">Tax Free</option>
                        </select>
                    </td>
                    <td>&nbsp;</td>
		...
		<table id="nonreactive">
			...
			<tbody>
				  <tr>
					...
					<td><input name="price" value="" jAutoCalc="{total} / {!qty}" /></td>
					<td><input name="total" value="" jAutoCalc="{qty} * {price}" /></td>
				  </tr>
			</tbody>
		</table>
    </body>

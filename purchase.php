...
<tr style="margin-bottom: 20px;">
		...
		<tr class="line_items text-center " style="margin-top:5px;">
			<td><button class="row-remove btn btn-danger " style=" margin-right:20px">Remove</button></td>
			 <td> <select class="form-control product_name" style="    margin-top: 11px;"   required="">
                ...
                <?php
          $sql=mysqli_query($conn,"select * from product where category='raw'");
    ...
    <td colspan="3">&nbsp;</td>
			...
			<td>&nbsp;</td>
			<td>  <input type="text" name="gtotal" id="grand" class="form-control" value="" jAutoCalc="({sub_total}-({sub_total} * {discount})/100)" readonly></td>
    </tr>
    ...
    <td colspan="3">&nbsp;</td>
			...
			<td>&nbsp;</td>
			<td>  <input type="text" name="rempay" id="rempay" class="form-control" value="" jAutoCalc="({grandtotal} - {paid_unpaid})" readonly></td>
    </tr>

    <tr>
    <td>
        <label class="fw-bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Discount %</label>
        <input type="number" step="any" name="discount" id="discount" class="form-control" style="margin-left:20px;" >
      </td>

      <td>
        <label class="fw-bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GST Tax %</label>
        <input type="number" step="any" name="gst" id="gst" class="form-control" style="margin-left:30px;" >
      </td>
      <td>
        <label class="fw-bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; WHT Tax %</label>
        <input type="number" step="any" name="wht" id="wht" class="form-control" style="margin-left:35px;" >
      </td>
    </tr>
                ...
                <div class="row">
                  ...
                  <table id="example" class="table table-bordered table-responsive" >
                    ...
                    <thead class="table-dark">
                      ...
                      <?php
                        $squery="select * from products_detail ORDER BY bill_id DESC";
...
?>
                            ...
                            <tr>
                                <td><?php echo $bill; ?></td>
                                <td style="width:120px;"><?php echo $supplier; ?></td>
                               
                                <td>
                               <?php 
                               $query=mysqli_query($conn,"select * from items where bill_id='$bill'")  ;                     
                                ...
                                <a href="pbill.php?sid=<?php echo $row['bill_id'] ?>" class="btn btn-sm btn-success"> <i class="fas fa-print"></i></a>
                                </td>
...
$('.status').each(function(){
 ...
 status.push({value: this.value})
				...
				$.ajax({
					...
					type: "POST",
					data: {sup_name:sup_name, product_name:product_name, quantity_name:quantity_name, price_name:price_name,tprice_name:tprice_name,bill_id:bill_id,status:status,name:name,uniqid:uniqid,status_bill:status_bill,discount:discount,final:final,wht:wht,sub:sub,paid_bill:paid_bill,rempay:rempay},

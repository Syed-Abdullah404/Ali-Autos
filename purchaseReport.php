...
define("TITLE","Purchase Report");
define("PAGE","Purchase Report");
...
<div class="container ">
 ...
 if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM items WHERE date BETWEEN '$startdate' AND '$enddate'";
    ...
    if($result->num_rows > 0){
     ...
     <table>
  <tr>
    <td><a href="purchaseBill.php" class="btn btn-danger mt-2">Print </a></td>
  </tr>
  </table>

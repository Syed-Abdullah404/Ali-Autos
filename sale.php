                                    ...
                                    <table name="cart table  responsive text-center">
                                        ...
                                        <tr class="line_items text-center " style="margin-top:5px;">
                                            ...
                                            <td> <select class="form-control product_name" style="    margin-top: 11px;" required="">
                                                    ...
                                                    <?php
                                                    $sql = mysqli_query($conn, "SELECT * FROM final_stock WHERE category='ready' AND quantity >0 ");
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td> <input type="text" name="ftotal" id="final" class="form-control" value="" jAutoCalc="({gtotal}+({gtotal} * {gst})/100)" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">&nbsp;</td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                $dis = 0;
                                                ?>
                                                <input type="number" step="any" name="discount" id="discount" class="form-control" style="margin-left:20px;" value='<?php echo $dis ?>'>
                                            ...
                                            <td>
                                                ...
                                                $gst = 0;
                                                ?>
                                                <input type="number" step="any" name="gst" id="gst" class="form-control" style="margin-left:30px;" value="<?php echo $gst ?>">
                                            </td>
                                            <td>
                                                <label class="fw-bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    WHT Tax %</label>
                                                ...
                                                $WHT = 0;
                                                ?>
                                                <input type="number" step="any" name="wht" id="wht" class="form-control" style="margin-left:35px;" value="<?php echo $WHT ?>">
                                            </td>
                                        </tr>
        ...
        <div class="col-md-12 p-5">
            <table id="example" class="table table-bordered">
                ...
                <tbody class="table-light">
                    <?php
                    $squery = "select * from sale_product_details ORDER BY bill_id DESC";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $query = mysqli_query($conn, "select * from sale_items where bill_id='$bill'");
                            ...
                            <td style="width:90px;">
                                ...
                                <a href="sbill.php?sid=<?php echo $row['bill_id'] ?>" class="btn btn-sm btn-success"> <i class="fas fa-print"></i></a>
                            </td>

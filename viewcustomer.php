...
<div class="container">
         <div class="card mm">
              <div class="card-header border-0">
                ...
                <a href="customer.php" type="button" class="btn btn-primary float-end mn">
                  <i class="fas fa-eye"></i> Customer
                </a>
